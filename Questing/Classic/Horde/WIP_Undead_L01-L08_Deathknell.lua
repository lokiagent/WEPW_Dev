...
--------------------------------------------------------------------------------------
---                       Finding and Looting World Objects                        ---
--------------------------------------------------------------------------------------
--BatteredChest = {}; -- Table to load Battered
--BatteredChest[1] = 2843; -- Battered Chest
--GatherBatteredChest = CreateObjective("GatherObject",1,1,1,364,TableToList(BatteredChest));
...
--DoObjective(GatherBatteredChest);
DoObjective(MindlessZ); DoObjective(MindlessW);
...
--    AcceptQuestUsingDB(); -- 
--end
--if Player.Class == 4 and not HasPlayerFinishedQuest(5651) then --Rogue
--    AcceptQuestUsingDB(); -- 
--end
